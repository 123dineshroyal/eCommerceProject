        ...
        <SafeAreaView style={styles.mainContainer}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.chatContainer}>
                    ...
                    <View style={styles.arrowDown}>
                        <Entypo name="chevron-small-down" size={30} color={COLORS.primary} />
            ...
            <View style={styles.bottomTab}>
                <View style={styles.bottomTabContain}>
                    <TouchableOpacity onPress={() => navigation.navigate(RouteName.CHAT_MESSAGING3_SCREEN)}>
...
export default ChatGoToTheBottom;
