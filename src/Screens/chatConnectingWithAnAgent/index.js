...
const ChatConnectingWithAnAgent = () => {
    ...
    return (
        <SafeAreaView style={styles.mainContainer}>
            ...
            <View style={styles.chatContainer}>
                ...
                <View style={styles.connectingAgentContainer}>
                    <TouchableOpacity style={styles.connectingAgentContain} onPress={() => navigation.navigate(RouteName.CHAT_AGENT_IS_TYPING_SCREEN)}>
                        <Text style={styles.connecting} />
                        <Text style={styles.connecting} />
                        <Text style={styles.connecting} />
                    </TouchableOpacity>
                    <Text style={styles.connectingText}>Connecting you with an agent</Text>
                </View>
...
export default ChatConnectingWithAnAgent;
