    ...
    <SafeAreaView style={styles.mainContainer}>
      ...
      <View style={styles.shippingContain}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate(RouteName.TO_RECEIVE_SCREEN)}
        >
      ...
      >
        <View style={styles.modalBackground}>
          <View style={styles.paymentProgressContainer}>
            ...
            <Button
              mode="contained"
              labelStyle={styles.trackYourOrderButtonText}
              style={styles.trackYourOrderButtonContainer}
...
export default YourCardBeenCharged;
...
const styles = StyleSheet.create({
  ...
  trackYourOrderButtonContainer: {
    backgroundColor: COLORS.elevation.level4,
    borderRadius: 10,
    paddingHorizontal: 10,
    marginVertical: 20,
  },
  trackYourOrderButtonText: {
    fontSize: 16,
    fontWeight: 300,
  },
});
