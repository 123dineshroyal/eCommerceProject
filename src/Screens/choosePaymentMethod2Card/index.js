...
const ChoosePaymentMethodCard2 = () => {
    ...
    <SafeAreaView style={styles.mainContainer}>
      ...
      <View style={styles.shippingContain}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate(RouteName.PAYMENT_IN_PROGRESS_SCREEN)}
        >
              ...
              <View style={styles.cardContain1}>
                <View style={styles.card2}>
                  <View style={styles.card1}>
                    ...
                    <TouchableOpacity style={styles.settingIcon} onPress={() => setModalVisible(false)}>
                      <Feather
                        name="settings"
                        size={20}
...
export default ChoosePaymentMethodCard2;
