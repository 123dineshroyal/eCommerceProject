...
const ToReceiveAttemptIsNotSuccessful = () => {
  ...
  return (
    <SafeAreaView style={styles.mainContainer}>
      <View style={styles.receiveContainer}>
        ...
        <TouchableOpacity style={styles.iconContainer} onPress={() => navigation.navigate(RouteName.DELIVERY_ATTEMPT_NOTIFICATION_SCREEN)}>
...
export default ToReceiveAttemptIsNotSuccessful;
